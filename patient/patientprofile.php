           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="patientprofile.php"><i class="fa fa-edit fa-3x"></i> Profile</a>
                    </li>
                    <li>
                             ...
                             <form role="form" name="form1" method="post" enctype="multipart/form-data">
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="disabledInput" disabled ><?php print $array[10]; ?></textarea>
                                        </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php print $array[8]; ?>" id="disabledInput" type="text" disabled />
                                        </div>
                                        <div class="form-group">
                                            <label>Disease</label>
                                            <textarea class="form-control" rows="5" id="disabledInput" disabled ><?php print $array[6]; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Mobile Number</label>
                                            <input class="form-control" value="<?php print $array[11]; ?>" id="disabledInput" type="text" disabled />
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input class="form-control" value="<?php print $array[12]; ?>" id="disabledInput" type="text" disabled />
                                        </div>
                                </div>
                                </form>
                            </div>
