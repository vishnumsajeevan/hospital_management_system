           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="viewnotifications.php"><i class="fa fa-qrcode fa-3x"></i> View Notifications</a>
                    </li>
                    <li>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="auto-style1">Message</th>
                                            <th class="auto-style1">Delete</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php
											...
											$i=1;
											$q="select * from tb_contactus order by mdate desc";
											$rese=mysql_query($q);
										...
										<tr>
                                            ...
                                            <a href="deletemsg.php?nam=<?php print $val[1]; ?>&email=<?php print $val[2]; ?>&msg=<?php print $val[3]; ?>">
                                            <button class="btn btn-primary"><i class="fa fa-pencil"></i> Delete</button>
                                            </a>
											</td>
                                        </tr>
                                        <?php
