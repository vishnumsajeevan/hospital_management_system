                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="auto-style1">Doctor</th>
                                    ...
                                    <tbody>
                                    	<?php
											include("../connect.php");
											$i=1;
											$q="select * from tb_patient where pstatus='1' order by pno desc";
											$rese=mysql_query($q);
