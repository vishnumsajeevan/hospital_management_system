                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<?php
											...
											$i=1;
											$q="select * from tb_appointment where apdate='$dat1' and pdoctor='$dname' and pstatus='0'";
											$rese=mysql_query($q);
                                        ...
                                        <tr>
                                            ...
                                            <a href="approveappointment.php?nam=<?php print $val[1]; ?>&mobno=<?php print $val[3]; ?>&dname=<?php print $dname; ?>">
